package icu.nescar.armee.jet.core.utils;


import icu.nescar.armee.jet.core.annotation.BuiltinComponent;
import icu.nescar.armee.jet.core.annotation.DebugOnly;
...
public class CommonUtils {
    ...
    public static boolean isBuiltinComponent(Class<?> userClass) {
        return userClass.isAnnotationPresent(BuiltinComponent.class)
                || icu.nescar.armee.jet.core.common.BuiltinComponent.class.isAssignableFrom(userClass);
    }
    ...
    public static boolean isDeprecatedClass(Class<?> userClass) {
        return userClass.isAnnotationPresent(Deprecated.class)
                ...
                || icu.nescar.armee.jet.core.common.DebugOnly.class.isAssignableFrom(userClass);
    }
