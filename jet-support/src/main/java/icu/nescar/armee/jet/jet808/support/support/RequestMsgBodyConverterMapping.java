...
public class RequestMsgBodyConverterMapping {
    ...
    public icu.nescar.armee.jet.jet808.support.support.RequestMsgBodyConverterMapping registerConverter(MsgType msgType, RequestMsgBodyConverter<? extends RequestMsgBody> converter) {
        return registerConverter(msgType, converter, false);
    }

    public icu.nescar.armee.jet.jet808.support.support.RequestMsgBodyConverterMapping registerConverter(
